...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  logoUrl = '/profile.jpg', // Default to a known image if logo doesn't exist
  menuButtonColor = '#fff',
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Main navigation header">
        <div className="sm-logo" aria-label="Logo">
          <span className="text-2xl font-display font-bold text-white tracking-widest uppercase ml-4 mt-4 block">SIHAN.</span>
        </div>
        <button
          ref={toggleBtnRef}
          className="sm-toggle mr-4 mt-4"
